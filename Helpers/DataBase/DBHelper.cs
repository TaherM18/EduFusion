...
using EduFusion.Helpers.Extensions;
using EduFusion.Helpers.Logger;
using Npgsql;

namespace EduFusion.Helpers.DB
{
    public class DBHelper
    {
        ...
        public async Task<DataTable> GetTableWithCondition(string tableName, Dictionary<string, object> conditions = null, string[] columns = null)
        {
            ...
            {
                LoggerHelper.AppendLog("ERROR in GetTableWithCondition", ex.Message);
        ...
        public async Task<int> InsertOne(string tableName, string[] colNames, List<object> values)
        {
            ...
            Console.WriteLine("DBHelper - InsertOne - placeholders:\n" + placeholders);
            ...
            {
                LoggerHelper.AppendLog("Error in InsertOne", ex.ToString());
                return 0;
            }
            finally
            {
        ...
        public async Task<int> InsertGetId(string tableName, string[] colNames, List<object> values, string pk)
        {
            ...
            {
                LoggerHelper.AppendLog("Error in InsertGetId", ex.ToString());
                return 0;
            }
            finally
            {
